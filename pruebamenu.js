        ...
        $.each(menus, function (i, v) {
            if (v.mostrarEnMenu == 'true') {
                ...
                if (subMenu.length == 0) {
                    ...
                    //menuGenrado += '<li class="treeview"><a href="' + v.link + '" class="dropdown-collapse"><i class="' + v.icono + '"></i><span>' + v.menu + '</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>';
                      menuGenrado += '<li class="treeview"><a href="' + v.link + '" class="dropdown-collapse"><i class="' + v.icono + '"></i><span>' + v.menu + '</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>';
