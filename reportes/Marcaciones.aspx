<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="Marcaciones.aspx.vb" Inherits="reportes_Marcaciones" %>
  ...
  <section class="content-header">
                            ...
                            <b><span style='font-size: 9pt; font-family: "Arial","sans-serif"; letter-spacing: 1.0pt; text-align: center;'>Usuario: </span></b>
                                ...
                                <tr>
                                    <td colspan="3">
                                        ...
                                        <span style='font-size: 11pt; font-family: "Arial","sans-serif"; letter-spacing: 1.0pt; text-align: center;'>Del: 
                                                <label  id="fechadel"></label>
                                                Al: 
                                                <label id="fechaal"></label>
                                        </span></p>                                    
                                        </dl>                                        
                                    </td>
                                </tr>
    ...
    <section class="content">
                                ...
                                <div class="col-md-4">
                                    <article class="l-design-widhtin">
                                        <label class="inputin">
                                            ...
                                            <div id="datepicker11" class="input-group date" data-date-format="dd/mm/yyyy">
                                                <input id="indate11" class="form-control" type="text" readonly />
     ...
     <script src="/bower_components/moment/min/jmoment.js"></script>
        ...
        <script src="js/JSMarcaciones.js"></script>
