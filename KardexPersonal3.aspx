<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="KardexPersonal3.aspx.vb" Inherits="KardexPersonal3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="form">
        <div class="modal fade" id="modal-NuevoKardex" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
            <form>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <article class="l-design-widhtin">
                                        <label class="inputin">
                                            <input class="inputin__fieldin" id="nacimiento" type="text" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask placeholder=" " data-validate="required" data-value-format="dd/mm/yyyy" data-validate-message="Ingrese Fecha de nacimiento" autocomplete="off" />
...
//GUARDAR ORDEN
          function guardar() {
              var idpersonal = $('#idpersonal').text();                                                
              var documento = $('#ci').val();                                       
...
//PREGUNTA SI DESEA GUARDAR   
 ...
 //OBTERNER DATOS AL EDITAR
              ...
              //****************************************
                  $.ajax({
                      ...
                      success: function (response) {
                          ...
                          //console.log(nestudio[response.d[17]-1])
              ...
              if (val.length > 1) {
                  $("#TablePersona").DataTable({
                      ...
                      "columns": [
                         ...
                         { "data": "telefono" },
                         { "data": "profesion" },
                         { "defaultContent": "<button type='button' id='Editar' class='editar btn btn-primary btn-sm checkbox-toggle'><i class='fa fa-pencil-square-o'></i></button>       <button type='button'id='Validar' class='validar btn btn-danger btn-sm' data-toggle='modal' data-target='#modalEliminar' ><i class='fa fa-trash-o'></i></button>" },
                      ]
                  });                                  
          ...
          $(function () {
              ...
              var $VentanaModal = $('#modal-NuevoKardex');

              $VentanaModal.on('hidden.bs.modal',function(event){
                  var $formulario = $VentanaModal.find('form');
                  $formulario[0].reset();
              });
          ...
          $(document).on('click', '#Validar', function () {         
              ...
              $.ajax({
                  ...
                  type: "POST",
                  contentType: "application/json; charset=utf-8",
                  url: "KardexPersonal3.aspx/Validar",
